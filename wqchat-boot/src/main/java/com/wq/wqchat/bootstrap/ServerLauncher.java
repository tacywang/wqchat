...
package com.wq.wqchat.bootstrap;


import com.wq.wqchat.bootstrap.job.*;
import com.wq.wqchat.core.server.*;

import static com.wq.wqchat.common.ServerNodes.*;
import static com.wq.wqchat.tools.config.CC.mp.net.tcpGateway;
import static com.wq.wqchat.tools.config.CC.mp.net.udpGateway;
import static com.wq.wqchat.tools.config.CC.mp.net.wsEnabled;
