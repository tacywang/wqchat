...
import static com.wq.wqchat.tools.config.CC.mp.net.traffic_shaping.gateway_server.*;
import static com.wq.wqchat.tools.config.CC.mp.net.write_buffer_water_mark.gateway_server_high;
import static com.wq.wqchat.tools.config.CC.mp.net.write_buffer_water_mark.gateway_server_low;
