...
package com.wq.wqchat.tools.thread.pool;

import com.wq.wqchat.api.push.PushException;
import com.wq.wqchat.api.spi.Spi;
import com.wq.wqchat.api.spi.common.ExecutorFactory;
...
import static com.wq.wqchat.tools.config.CC.mp.thread.pool.ack_timer;
import static com.wq.wqchat.tools.config.CC.mp.thread.pool.push_client;
import static com.wq.wqchat.tools.config.CC.mp.thread.pool.push_task;
import static com.wq.wqchat.tools.thread.ThreadNames.*;
