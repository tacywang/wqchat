...
package com.wq.wqchat.tools.config;
...
import com.wq.wqchat.api.spi.net.DnsMapping;
import com.wq.wqchat.tools.config.data.RedisNode;
...
public interface CC {
    ...
    interface mp {
        ...
        Boolean message_process_asyn =  cfg.getBoolean("message_process_asyn");
        interface core {
        ...
        interface mongo {
			Config cfg = mp.cfg.getObject("mongo").toConfig();
			...
			int maxConnectionsPerHost = cfg.getInt("maxConnectionsPerHost");
			int threadsAllowedToBlockForConnectionMultiplier = cfg
					.getInt("threadsAllowedToBlockForConnectionMultiplier");
			int serverSelectionTimeout = cfg.getInt("serverSelectionTimeout");
			int maxWaitTime = cfg.getInt("maxWaitTime");
			int maxConnectionIdleTime = cfg.getInt("maxConnectionIdleTime");
			int maxConnectionLifeTime = cfg.getInt("maxConnectionLifeTime");
			int connectTimeout = cfg.getInt("connectTimeout");
			int socketTimeout = cfg.getInt("socketTimeout");
			String dbName = cfg.getString("dbName");
			String userName = cfg.getString("userName");
			String password = cfg.getString("password");
			String domains = cfg.getString("domains");
		}
