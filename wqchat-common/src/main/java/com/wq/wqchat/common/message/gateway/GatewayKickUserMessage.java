...
package com.wq.wqchat.common.message.gateway;

import static com.wq.wqchat.api.protocol.Command.GATEWAY_KICK;

import com.wq.wqchat.api.connection.Connection;
import com.wq.wqchat.api.protocol.Packet;
import com.wq.wqchat.common.memory.PacketFactory;
import com.wq.wqchat.common.message.ByteBufMessage;
import com.wq.wqchat.common.router.KickRemoteMsg;
